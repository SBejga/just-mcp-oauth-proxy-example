...
from mcp_oauth_example.auth import AuthenticationError, EntraIDAuth, TokenInfo
...
class TestEntraIDAuth:
    ...
    def test_generate_pkce_pair(self, auth_handler):
        ...
        expected_challenge = (
            base64.urlsafe_b64encode(expected_challenge).decode("utf-8").rstrip("=")
        )
    ...
    async def test_exchange_code_for_tokens_success(self, auth_handler):
        ...
        token_info = await auth_handler.exchange_code_for_tokens(
