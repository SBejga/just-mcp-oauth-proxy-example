...
class MCPOAuthClient:
    ...
    async def call_mcp_tool(
        ...
        if not self.token:
            raise ValueError(
                "Not authenticated. Call authenticate_interactive() first."
            )
        ...
        request_data = {"method": f"tools/{tool_name}", "params": params or {}}
    ...
    async def demo_workflow(self) -> None:
        ...
        await self.call_mcp_tool(
            "save_user_note", {"note": "This is a test note from the OAuth client!"}
        )
