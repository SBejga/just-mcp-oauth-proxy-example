...
class EntraIDAuth:
    ...
    async def exchange_code_for_tokens(
        ...
        try:
            ...
            raise AuthenticationError(f"Failed to exchange code for tokens: {str(e)}") from e
    ...
    def create_jwt_token(self, user_info: Dict[str, Any]) -> str:
        ...
        payload = {
            "user_info": user_info,
            "exp": datetime.now(timezone.utc) + timedelta(seconds=self.config.token_expiry_seconds),
